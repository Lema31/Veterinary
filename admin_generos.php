    ...
    <body>
                   ...
                   <div class="text-start">
                        ...
                        <div class="row text-center">
                            <div class="col d-flex align-items-center">
                                <header>
                                    <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#Nueva-Género"> Nuevo </button>
                                </header>
                                <!-- Modal-->
                                <div class="modal fade" id="Nueva-Género" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header text-center">
                                                <h5 class="modal-title" id="ModalLabel"> Registrar Género</h5>
                                            ...
                                            <form id="form_nuevo">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="Descripcion_Género">Descripción</span>
                                                        <input type="text" id="nuevo_descripcion" class="form-control" placeholder="Descripción del Género" aria-describedby="Descripcion_Género">
                                                    </div>
                                                    <!--Nombre del Reino-->
                                                    <div class="input-group mb-3">
                                ...
                                <form class="form-floating ms-5 w-50" id="form_buscar" method="GET" action="">
                                        ...
                                        <input type="text" name="nombre_gen" class="form-control mb-4" id="floatingInput" placeholder="Buscar Administradores">
                                        <label for="floatingInput">Nombre del Genero</label>
                               ...
                               <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"> Familia a la que pertenece</th>
                                        <th scope="col"> Acciones</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                        if(isset($_GET['nombre_gen'])){
                                            $nombre = $_GET['nombre_gen'];
                                            $generos_query = "select a.cod_genero,a.descripcion_gen,b.cod_familia,b.descripcion_fam,c.cod_orden,c.descripcion_ord,d.cod_clase,d.descripcion_cla,e.cod_phylum,e.descripcion_phy,e.cod_reino from tbl_generos as a inner join tbl_familias as b on a.cod_familia = b.cod_familia inner join tbl_ordenes as c on b.cod_orden = c.cod_orden inner join tbl_clases as d on c.cod_clase = d.cod_clase inner join tbl_phylums as e on d.cod_phylum = e.cod_phylum where a.descripcion_gen like '$nombre%' order by a.descripcion_gen";
                                            $generos = $pdo->prepare($generos_query);
                                            $generos->execute();
                                            $resultado_taxonomia = $generos->fetchAll();
                                        }
                                        foreach ($resultado_taxonomia as $data): ?>
                                   <tr>
                                        <th scope="row"><?php echo $data['cod_genero']; ?></th>
                                        <td><?php echo $data['descripcion_gen']; ?></td>
                                        <td><?php echo $data['descripcion_fam']; ?></td>
                                        <td>  
                                            <div class="btn-group">
                                                <button class="btn btn-success edit" value="<?php echo $data['cod_genero']; ?>" data-bs-toggle="modal" data-bs-target="#Modificar-Género<?php echo $data['cod_genero']; ?>"><span>Modificar</span></button>
                                                <a href="php/genero/delete_genero.php?codigo=<?php echo $data['cod_genero']; ?>">
                                                    <button class="btn btn-danger"> Eliminar </button>
                                                </a>
                                            </div> 
                                            <!-- Modal-->
                                            <div class="modal fade" id="Modificar-Género<?php echo $data['cod_genero']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header text-center">
                                                            <h5 class="modal-title" id="ModalLabel"> Modificar Género</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <form id="form_modificar<?php echo $data['cod_genero']; ?>">
                                                            <div class="modal-body">
                                                                <!--Descripción-->
                                                                <div class="input-group mb-3">
                                                                    <span class="input-group-text" id="Descripcion_Género">Descripción</span>
                                                                    <input type="text" id="descripcion_<?php echo $data['cod_genero']; ?>" class="form-control" placeholder="Descripción de la Género" value="<?php echo $data['descripcion_gen']; ?>" aria-describedby="Descripcion_Género">
                                                                </div>
                                                                <!--Nombre del Reino-->
                                                                <div class="input-group mb-3">
                                                                    <span class="input-group-text" id="Nombre_Reino">Nombre del Reino</span>
                                                                    <select id="select_reino<?php echo $data['cod_genero']; ?>" class="form-control">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select id="select_phylum<?php echo $data['cod_genero']; ?>" class="form-control">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select id="select_clase<?php echo $data['cod_genero']; ?>" class="form-control">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select id="select_orden<?php echo $data['cod_genero']; ?>" class="form-control">
                                                                ...
                                                                <!--Nombre de la familia-->
                                                                <div class="input-group mb-3">
                                                                    <span class="input-group-text" id="Nombre_Familia">Nombre del Clase</span>
                                                                    <select id="select_familia<?php echo $data['cod_genero']; ?>" class="form-control">
        ...
        <script>
            ...
            $('#form_nuevo').submit(e => {
                ...
                if(nuevo_descripcion.length == 0 || nuevo_reino == '' || nuevo_phylum == '' || nuevo_clase == '' || nuevo_orden == '' || nuevo_familia == ''){
                    alert('Debes completar todos los campos');
                }else{
                    $.ajax({
                        data: {nuevo_descripcion,nuevo_familia},
                        url: "php/genero/registrar_genero.php",
                        type: "POST",
                        error: function(request, status, error){
                            alert("ocurrio un error "+request.responseText)
                            console.log(error)
            ...
            $(document).on('click','.edit', function(){
                ...
                $('#form_modificar'+codigo_actual).submit(e =>{
                    ...
                    if(modificar_descripcion.length == 0 || modificar_phylum == '' || modificar_clase == '' || modificar_orden == '' || modificar_familia == ''){
                        alert("Debe rellenar todos los campos");
                    }else{

                        $.ajax({
                            data: {modificar_descripcion,modificar_familia,codigo_actual},
                            url: "php/genero/modificar_genero.php",
                            type: "POST",
