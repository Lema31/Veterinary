<?php 
	...
	$editar_propietario_query = 'update tbl_propietarios set direccion = ? where cedula = ?';
	$editar_propietario = $pdo->prepare($editar_propietario_query);
	$editar_propietario->execute(array($direccion,$cedula_actual));
