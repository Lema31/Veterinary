<?php 
	...
	$add_propietario_query = 'insert into tbl_propietarios (cedula, direccion) values(?,?)';
	$add_propietario = $pdo->prepare($add_propietario_query);
	$add_propietario->execute(array($cedula,$direccion));


  	$add_element_usuario= null;
  	$validar_persona = null;
  	$add_propietario = null;
  	$pdo = null;
